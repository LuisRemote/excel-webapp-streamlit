...
st.header("Surver Results 2021")
st.subheader("Yes, it was")
...
# --- Plot bar chart ---
bar_chart = px.bar(df_grouped, x='Rating', y='Votes',
                   text='Votes', color_discrete_sequence = ['#F63366']*len(df_grouped),
